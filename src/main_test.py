...
if __name__ == '__main__':
    ...
    deep_model = ddqn_model.ddqn(alpha=0.0005, gamma=0.99, n_actions=airstrikers.n_actions, epsilon=0, epsilon_decay=0,
    ...
    airstrikers.test(runs=101, deep_model=deep_model, test_model_name='ddqn-models/huber_maxpool-27229-8batches_model.h5')
